...
public class Modele extends GenericDAO {
  ...
  public static List<MpModelView> getListeModele(DBConnection dbConnection,
    ...
    while (resultSet.next()) {
      ...
      mpModelView.setIdMatierePremiere(
          resultSet.getString("idMatierePremiere"));
  ...
  public static List<MpModelView> getMatierePremiere(DBConnection dbConnection,
                                                     String ids)
      throws SQLException {
    ...
    String sql =
        "SELECT * FROM v_modele_mp WHERE \"idFormat\" = ? AND \"id_style\" = ?";
    PreparedStatement preparedStatement =
        dbConnection.getConnection().prepareStatement(sql);
  ...
  public static List<MpModelView>
  getListeModelParPrix(DBConnection dbConnection, double min, double max)
      throws SQLException {
  ...
  public String getIdStyle() { return idStyle; }
