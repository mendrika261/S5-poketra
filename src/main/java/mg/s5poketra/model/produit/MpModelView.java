...
public class MpModelView {
  ...
  public void setNomFormat(String nomFormat) { this.nomFormat = nomFormat; }
  ...
  public void setIdFormat(String idFormat) { this.idFormat = idFormat; }
  ...
  public String getNomStyle() { return nomStyle; }

  public void setNomStyle(String nomStyle) { this.nomStyle = nomStyle; }

  public String getIdStyle() { return idStyle; }

  public void setIdStyle(String idStyle) { this.idStyle = idStyle; }
}
